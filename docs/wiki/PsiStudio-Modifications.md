...
[[/images/PipelinePluginBrowser.png]]
...
[[/images/AdditionalPipelinePlugins.png]]
...
[[/images/AdditionalAssemblies.png]]
...
**UI Layout:**
[[/images/ExternalViewerBrowser.png]]
...
- **Pipeline Plugin**: Executes on dedicated worker thread, if PsiStudio crashes the pipeline might still run.
- **Network Streams**: Non-blocking async operations
- **External Viewer**: Basic process communication on child application, if PsiStudio crashes the application might still run.
