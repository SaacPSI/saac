...
namespace SAAC.PsiFormats
{
    ...
    /// </summary>
    public class PsiFormatHapticPlay : IPsiFormat
    {
        /// <summary>
        /// Gets the format for serializing and deserializing HapticPlay values.
        /// </summary>
        /// <returns>A format instance for HapticPlay serialization.</returns>
