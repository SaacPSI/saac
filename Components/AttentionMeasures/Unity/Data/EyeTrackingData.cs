...
//Enum with the different kind of data recovered
public enum ETData
{
    LeftEyePosition,
    LeftEyeRotation,
...
//interface to store data of multiple types in a dictionary
...
//Template with the different data we recover. This template allow to create an empty dictionary resembling our data,
//but also to cycle through it knowing which type of IEyeTracking it is (when reading the format for example)
