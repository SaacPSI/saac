...
namespace Microsoft.Psi.Interop.Transport.TEST
{
    using System;
    ...
    public class TcpSource<T> : IProducer<T>, ISourceComponent, IDisposable
    {
        ...
        public void Dispose()
        {
            if(this.client.Connected)
                this.networkStream.ReadTimeout = 100;
            //this.networkStream.Close(10);
            //this.client.Close();
        ...
        private void ReadFrames()
        {
            ...
            try
            {
                ...
                using var reader = new BinaryReader(this.networkStream);
